        ...
        return (
            <div className="flex gap-4 py-4 px-5 items-center border-b md:border-t  border-[#EDF0F2]">
                <div className='flex gap-4 items-center basis-[48%]' >
                    ...
                    <Link to={"/card"} onClick={() => onOpenCard(_id)} className="fle flex-col gap-1.5">

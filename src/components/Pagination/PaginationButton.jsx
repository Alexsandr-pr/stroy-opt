...
export const PaginationButtonLeft = ({cb, disabled}) => {
    return (
        <button disabled={disabled} onClick={() => cb()} className='disabled:opacity-45 text-black w-[56px] m46:w-auto m46:h-auto h-[56px] m46:py-[18.3px] m46:px-6 bg-white rounded-md border border-pagination-border flex justify-center items-center gap-2.5'>
            ...
            <span className='text-sm text-[#25282C] hidden m46:block font-normal leading-tight '>Назад</span>
        </button>
    )
}
...
export const PaginationButtonRight = ({cb, disabled}) => {
    return (
        <button disabled={disabled} onClick={() => cb()} className=' disabled:opacity-45 items-center m46:w-auto m46:h-auto justify-center text-black w-[56px] h-[56px] m46:py-[18.3px] m46:px-6 bg-white rounded-md border border-pagination-border flex  gap-2.5' >
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="10" viewBox="0 0 23 10" fill="none">
            ...
            <span className='text-sm text-[#25282C] font-normal leading-tight hidden m46:block'>Далее</span>
        </button>
    )
}